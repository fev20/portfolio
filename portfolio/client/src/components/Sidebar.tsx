...
컴퓨터공학과
        ...
        <div className="flex-shrink-0">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-5 py-2.5 transition-all"
          ...
          <a
            ...
            style={{ color: "#64748b", textDecoration: "none", borderTop: "1px solid rgba(100,255,218,0.05 )" }}
          ...
          >
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem" }}>github/fev20</span>
          </a>
        </div>
      </motion.aside>
