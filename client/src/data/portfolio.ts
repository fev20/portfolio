...
export const education = [
  ...
  },
  {
    ...
    description: "운영체제와 네트워크 보안 윈도우의 주요 기능과 보안, 리눅스의 주요 기능과 보안, 네트워크 및 보안 프로토콜 기초",
    icon: "shield",
  ...
  },
  {
    ...
    subtitle: "KISA Academy",
    description: "인프라와 웹의 위협 기술 후속공격 분석 윈도우의 보안 체계 우회 웹 보안 위협과 대응 기술",
    icon: "shield",
  ...
  },
  {
    ...
    subtitle: "KISA Academy",
    description: "침입탐지 및 차단 시스템 IDS/IPS 솔루션을 이용한 네트워크 위협 탐지, 차단 및 관리",
    icon: "shield",
  ...
  },
  {
    ...
    subtitle: "KISA Academy",
    description: "방화벽과 웹 애플리케이션 방화벽 방화벽을 이용한 네트워크 위협 탐지/차단/관리 WAF 솔루션을 이용한 웹 애플리케이션 기반 위협 탐지 차단 및 관리",
    icon: "shield",
